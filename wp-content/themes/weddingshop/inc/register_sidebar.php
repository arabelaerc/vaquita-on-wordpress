...
$ftc_default_sidebars = array(
						array(
							'name' => esc_html__( 'Home Sidebar', 'weddingshop' ),
							'id' => 'home-sidebar',
							'description' => '',
						...
						,array(
							'name' => esc_html__( 'Blog Sidebar', 'weddingshop' ),
							'id' => 'blog-sidebar',
							'description' => '',
							'before_widget' => '<section id="%1$s" class="widget-container %2$s">',
							'after_widget' => '</section>',
						...
						,array(
							'name' => esc_html__( 'Blog Detail Sidebar', 'weddingshop' ),
						...
						,array(
							'name' => esc_html__( 'Product Category Sidebar', 'weddingshop' ),
						...
						,array(
							'name' => esc_html__( 'Product Category Top Content', 'weddingshop' ),
						...
						,array(
							'name' => esc_html__( 'Product Detail Sidebar', 'weddingshop' ),
						...
						,array(
							'name'          => esc_html__( 'Product Detail Social Icon', 'weddingshop' ),
                                                        'id'            => 'product-detail-social-icon',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add social icon in your product detail page.', 'weddingshop' ),
						)
					);

$ftc_default_widgetareas = array(
                                        array(
							'name'          => esc_html__( 'Footer Top', 'weddingshop' ),
                                                        'id'            => 'footer-top',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'weddingshop' ),
					)
					,array(
							'name'          => esc_html__( 'Footer Middle', 'weddingshop' ),
                                                        'id'            => 'footer-middle',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'weddingshop' ),
					...
					,array(
							'name'          => esc_html__( 'Footer Bottom', 'weddingshop' ),
                                                        'id'            => 'footer-bottom',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'weddingshop' ),
