...
function ftc_custom_colors_css() {
	...
	/**
	 * Filter weddingshop default saturation level.
	 *
...
.colors-custom .post-info a:focus,
.colors-custom .post-info a:hover,
...
.colors-custom .post-info blockquote.alignleft,
.colors-custom .post-info blockquote.alignright,
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters weddingshop custom colors CSS.
	 *
	 * @since weddingshop 1.0
	 *
