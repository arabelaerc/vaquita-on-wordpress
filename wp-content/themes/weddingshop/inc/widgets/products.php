...
if( !class_exists('Ftc_Products_Widget') ){
	class Ftc_Products_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-products-widget', 'description' => esc_html__('Display your products on site','weddingshop'));
			parent::__construct('ftc_products', esc_html__('FTC - Products','weddingshop'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			if( $products->have_posts() ){
				...
				$extra_class = '';
				$extra_class .= ($is_slider)?'ftc-slider owl-carousel owl-loaded':'';
				$extra_class .= ($is_slider && $show_nav)?' has-navi':'';
				
				?>
				
				<div class="ftc-products-widget-wrapper woocommerce <?php echo esc_attr($extra_class); ?>" data-slider="<?php echo esc_attr($is_slider) ?>" data-show_nav="<?php echo esc_attr($show_nav) ?>" data-auto_play="<?php echo esc_attr($auto_play) ?>">
					<?php while( $products->have_posts() ): $products->the_post(); $product = wc_get_product( $post->ID ); ?>
						...
						<?php endif; ?>
							<li>
								<a class="ftc-wg-thumbnail" href="<?php echo esc_url( get_permalink($product->get_id()) ); ?>" title="<?php echo esc_attr( $product->get_title() ); ?>">
									<?php  
										if ( $show_thumbnail ) {
											if( !$lazy_load ){
												...
												echo '<img src="'.esc_url($placeholder_img_src).'" data-src="'.esc_url($img_src).'" alt="'.esc_attr($alt).'" class="attachment-shop_thumbnail wp-post-image ftc-lazy-load" width="'.$dimensions['width'].'" height="'.$dimensions['height'].'" />';
											}
										}
									?>
								</a>
								
								<div class="ftc-wg-meta item-description">
                                                                        <?php if( $show_categories ){ 
										ftc_template_loop_categories(); 
									} ?>
									
									<?php if( $show_rating ){ woocommerce_template_loop_rating(); } ?>
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Enter your title', 'weddingshop'); ?> </label>
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('product_type'); ?>"><?php esc_html_e('Product type', 'weddingshop'); ?> </label>
				<select class="widefat" id="<?php echo $this->get_field_id('product_type'); ?>" name="<?php echo $this->get_field_name('product_type'); ?>">
					<option value="recent" <?php selected($instance['product_type'], 'recent'); ?>><?php esc_html_e('Recent', 'weddingshop'); ?></option>
					<option value="sale" <?php selected($instance['product_type'], 'sale'); ?>><?php esc_html_e('Sale', 'weddingshop'); ?></option>
					<option value="featured" <?php selected($instance['product_type'], 'featured'); ?>><?php esc_html_e('Featured', 'weddingshop'); ?></option>
					<option value="best_selling" <?php selected($instance['product_type'], 'best_selling'); ?>><?php esc_html_e('Best selling', 'weddingshop'); ?></option>
					<option value="top_rated" <?php selected($instance['product_type'], 'top_rated'); ?>><?php esc_html_e('Top rated', 'weddingshop'); ?></option>
					<option value="mixed_order" <?php selected($instance['product_type'], 'mixed_order'); ?>><?php esc_html_e('Mixed order', 'weddingshop'); ?></option>
				</select>
			</p>
			
			<p>
				<label><?php esc_html_e('Select categories', 'weddingshop'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('row'); ?>"><?php esc_html_e('Number of rows - in carousel slider', 'weddingshop'); ?> </label>
				<input class="widefat" id="<?php echo $this->get_field_id('row'); ?>" name="<?php echo $this->get_field_name('row'); ?>" type="number" min="0" value="<?php echo esc_attr($instance['row']); ?>" />
                        ...
                        <p>
				<label for="<?php echo $this->get_field_id('columns'); ?>"><?php esc_html_e('Columns', 'weddingshop'); ?> </label>
				<input class="widefat" id="<?php echo $this->get_field_id('columns'); ?>" name="<?php echo $this->get_field_name('columns'); ?>" type="number" min="0" value="<?php echo esc_attr($instance['columns']); ?>" />
                        ...
                        <p>
				<label for="<?php echo $this->get_field_id('margin'); ?>"><?php esc_html_e('Margin', 'weddingshop'); ?> </label>
				<input class="widefat" id="<?php echo $this->get_field_id('margin'); ?>" name="<?php echo $this->get_field_name('margin'); ?>" type="text" value="<?php echo esc_attr($instance['margin']); ?>" />
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Number of products to show', 'weddingshop'); ?> </label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php esc_html_e('Show thumbnail', 'weddingshop'); ?></label>
			</p>
                        
			<p>
				<label for="<?php echo $this->get_field_id('thumbnail_size'); ?>"><?php esc_html_e('Thumbnail size', 'weddingshop'); ?> </label>
				<select class="widefat" id="<?php echo $this->get_field_id('thumbnail_size'); ?>" name="<?php echo $this->get_field_name('thumbnail_size'); ?>">
					<option value="shop_thumbnail" <?php selected($instance['thumbnail_size'], 'shop_thumbnail'); ?>><?php esc_html_e('Product Thumbnails', 'weddingshop'); ?></option>
					<option value="shop_catalog" <?php selected($instance['thumbnail_size'], 'shop_catalog'); ?>><?php esc_html_e('Catalog Images', 'weddingshop'); ?></option>
					<option value="shop_single" <?php selected($instance['thumbnail_size'], 'shop_single'); ?>><?php esc_html_e('Single Product Image', 'weddingshop'); ?></option>
				</select>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_categories'); ?>"><?php esc_html_e('Show categories', 'weddingshop'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_product_title'); ?>"><?php esc_html_e('Show product title', 'weddingshop'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_price'); ?>"><?php esc_html_e('Show price', 'weddingshop'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_rating'); ?>"><?php esc_html_e('Show rating', 'weddingshop'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('is_slider'); ?>"><?php esc_html_e('Show in a carousel slider', 'weddingshop'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_nav'); ?>"><?php esc_html_e('Show navigation button', 'weddingshop'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('auto_play'); ?>"><?php esc_html_e('Auto play', 'weddingshop'); ?></label>
			</p>
