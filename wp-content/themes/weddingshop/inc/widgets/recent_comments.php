...
if (!class_exists('Ftc_Recent_Comments_Widget')) {
    ...
    class Ftc_Recent_Comments_Widget extends WP_Widget {
        ...
        function __construct() {
            $widgetOps = array('classname' => 'ftc-recent-comments-widget', 'description' => esc_html__('Display recent comments on site', 'weddingshop'));
            parent::__construct('ftc_recent_comments', esc_html__('FTC - Recent Comments', 'weddingshop'), $widgetOps);
        }
        ...
        function widget($args, $instance) {
            ...
            if ($comments):
                ...
                ?>
                <div class="ftc-recent-comments-widget-wrapper <?php echo esc_attr($extra_class); ?>" data-show_nav="<?php echo esc_attr($show_nav) ?>" data-auto_play="<?php echo esc_attr($auto_play) ?>">
                                ...
                                <li>
                                    <div class="comment-meta">
                                        ...
                                        <div class="meta">
                                            ...
                                            <?php endif; ?>
                                            <?php if ($show_comment): ?>
                                                <p class="comment-body"><?php echo ftc_string_limit_words(wp_strip_all_tags(get_comment_text()), 3); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
        ...
        function form($instance) {
            ...
            $post_types = array_merge(array('all' => esc_html__('All Posts', 'weddingshop')), $post_types);
            ?>
            <p>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('post_type'); ?>"><?php echo esc_html_e('Post type', 'weddingshop'); ?> </label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Number of comments to show', 'weddingshop'); ?> </label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('show_avatar'); ?>"><?php esc_html_e('Show avatar', 'weddingshop'); ?></label>
            </p>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Show comment date', 'weddingshop'); ?></label>
            </p>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Show comment author', 'weddingshop'); ?></label>
            </p>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('show_comment'); ?>"><?php esc_html_e('Show comment content', 'weddingshop'); ?></label>
            </p>
