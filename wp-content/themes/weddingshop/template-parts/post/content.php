    ...
    <?php if ($smof_data['ftc_blog_title']): ?>
                    <h3 class="heading-title entry-title">
                        ...
                        if (is_sticky() && is_home() && !is_paged()): {
                            printf('<span class="sticky-post">%s</span>', esc_html__('Featured', 'weddingshop'));
                        }
                        ?>
                    <?php endif; ?>
                    </h3>
            ...
            <?php endif; ?>
                ...
                <?php wp_link_pages(); ?>
                    ...
                    <?php if ($smof_data['ftc_blog_read_more']): ?>
                        <a class="button-readmore" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More', 'weddingshop'); ?></a>
    <?php endif; ?>
                ...
                <?php if ($categories_list && $smof_data['ftc_blog_categories']): ?>
                        <div class="caftc-link">
                            <span class="caftc-title"><?php esc_html_e('Categories: ', 'weddingshop'); ?></span>
        ...
        <?php endif; ?>
                    ...
                    <span class="vcard author">
                        <span class="vcard-title"><?php esc_html_e('Post by ', 'weddingshop'); ?></span>
