...
if( $related_posts->have_posts() ){
	...
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="theme-title">
			<h3 class="heading-title"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'weddingshop'); ?></span></span></h3>
		</header>
			...
			<div class="blogs owl-carousel">
				...
				while( $related_posts->have_posts() ): $related_posts->the_post();
					...
					<div class="post-info">
						...
						<!-- Blog Author -->
						<!--<span class="author"><?php //esc_html_e('Post by ','weddingshop') ?><?php //the_author_posts_link(); ?></span>-->
						
						<!-- Blog Read More -->
						<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','weddingshop') ?></a>
