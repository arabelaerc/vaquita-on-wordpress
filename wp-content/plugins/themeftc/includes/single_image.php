...
if( !class_exists('Ftc_Single_Image_Widget') ){
	class Ftc_Single_Image_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-smooth-image', 'description' => esc_html__('Display a single image', 'themeftc'));
		...
		?>
			...
			<p>
				...
				<select class="widefat" name="<?php echo $this->get_field_name('style_effect'); ?>" id="<?php echo $this->get_field_id('style_effect'); ?>">
					<option value="smooth-image" <?php selected('eff-widespread-corner-left-right', $instance['style_effect']) ?>><?php esc_html_e('Widespread Corner', 'themeftc') ?></option>
					<option value="smooth-border-image" <?php selected('eff-border-scale', $instance['style_effect']) ?>><?php esc_html_e('Border Scale', 'themeftc') ?></option>
					<option value="smooth-background-image" <?php selected('eff-fade', $instance['style_effect']) ?>><?php esc_html_e('Fade', 'themeftc') ?></option>
				</select>
			</p>
